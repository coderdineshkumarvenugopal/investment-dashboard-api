...
const calculatePortfolioMetrics = () => {
    ...
    const topPerformer = portfolioData.holdings.reduce((best, current) => current.gainLossPercent > best.gainLossPercent ? current : best);
    const worstPerformer = portfolioData.holdings.reduce((worst, current) => current.gainLossPercent < worst.gainLossPercent ? current : worst);
    return {
        totalValue,
        totalInvested,
        totalGainLoss,
